 ...
 */
export function Entity(modelName: string, options?: Partial<IEntityOptions>): ClassDecorator;
 ...
 */
export function Entity(nameOrOptions: string | IEntityOptions, maybeOptions?: Partial<IEntityOptions>): ClassDecorator {
