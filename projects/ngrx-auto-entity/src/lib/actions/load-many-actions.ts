...
export class LoadManySuccess<TModel> extends EntityAction<TModel> {
   ...
   * @param criteria - The custom criteria from the initial load many action
   * @param correlationId - The correlation id for this action; correlates to the initial load many action
   */
