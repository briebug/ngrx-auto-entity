...
export const createLoadManyAction = <TModel, T extends string, P extends StandardProps>(
  ...
  cacheOnType(Type, EntityActionTypes.LoadMany, () => defineTypedFactoryFunction(
...
export const createLoadManyIfNecessaryAction = <TModel, T extends string, P extends LoadManyIfNecessaryProps>(
  ...
  cacheOnType(Type, EntityActionTypes.LoadManyIfNecessary, () => defineTypedFactoryFunction(
    setActionType(EntityActionTypes.LoadManyIfNecessary, Type),
    ({ maxAge, criteria, correlationId }: LoadManyIfNecessaryProps) =>
      new LoadManyIfNecessary(Type, maxAge, criteria, correlationId)
  ));
...
export const createLoadManySuccessAction = <TModel, T extends string, P extends LoadManySuccessProps<TModel>>(
  ...
  cacheOnType(Type, EntityActionTypes.LoadManySuccess, () => defineTypedFactoryFunction(
    setActionType(EntityActionTypes.LoadManySuccess, Type),
    ({ entities, criteria, correlationId }: LoadManySuccessProps<TModel>) =>
      new LoadManySuccess(Type, entities, criteria, correlationId)
  ));
...
export const createLoadManyFailureAction = <TModel, T extends string, P extends LoadManyFailureProps<TModel>>(
  ...
  cacheOnType(Type, EntityActionTypes.LoadManyFailure, () => defineTypedFactoryFunction(
    setActionType(EntityActionTypes.LoadManyFailure, Type),
    ({ error, criteria, correlationId }: LoadManyFailureProps<TModel>) =>
      new LoadManyFailure(Type, error, criteria, correlationId)
  ));
