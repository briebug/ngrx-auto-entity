...
export const createLoadPageAction = <TModel, T extends string, P extends StandardProps>(
  ...
  cacheOnType(Type, EntityActionTypes.LoadPage, () => defineTypedFactoryFunction(
...
export const createLoadPageIfNecessaryAction = <TModel, T extends string, P extends LoadPageIfNecessaryProps>(
  ...
  cacheOnType(Type, EntityActionTypes.LoadPageIfNecessary, () => defineTypedFactoryFunction(
...
export const createLoadPageSuccessAction = <TModel, T extends string, P extends LoadPageSuccessProps<TModel>>(
  ...
  cacheOnType(Type, EntityActionTypes.LoadPageSuccess, () => defineTypedFactoryFunction(
    setActionType(EntityActionTypes.LoadPageSuccess, Type),
    ({ entities, criteria, correlationId }: LoadPageSuccessProps<TModel>) =>
      new LoadPageSuccess(Type, entities, criteria, correlationId)
  ));
...
export const createLoadPageFailureAction = <TModel, T extends string, P extends LoadPageFailureProps<TModel>>(
  ...
  cacheOnType(Type, EntityActionTypes.LoadPageFailure, () => defineTypedFactoryFunction(
    setActionType(EntityActionTypes.LoadPageFailure, Type),
    ({ error, criteria, correlationId }: LoadPageFailureProps<TModel>) =>
      new LoadPageFailure(Type, error, criteria, correlationId)
  ));
